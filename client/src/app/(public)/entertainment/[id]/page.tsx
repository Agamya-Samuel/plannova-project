...
import { ArrowLeft, Music, MapPin, Phone, Mail, PlusCircle, Star } from 'lucide-react';
...
export default function EntertainmentDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  }, [serviceId, fetchEntertainmentService]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-white to-orange-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Entertainment Service</h1>
