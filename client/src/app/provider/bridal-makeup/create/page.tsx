...
export default function CreateBridalMakeupService() {
  const { user } = useAuth();
  ...
  const isTabCompleted = (tabId: string) => {
    ...
    switch (tabId) {
        ...
        case 'services':
            return formData.makeupTypes.length > 0 && formData.packages[0]?.name.trim() && formData.packages[0]?.price > 0;
        case 'policies':
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let errorMessage = 'Failed to create bridal makeup service';
        ...
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">Create Bridal Makeup Service</h1>
                <p className="text-gray-600 text-lg">Set up your bridal makeup service profile</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              {activeTab === 'basic' && (
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea value={formData.description} onChange={(e) => handleInputChange('description', e.target.value)} placeholder="Describe your bridal makeup services and experience..." rows={4} className="w-full px-4 py-3 border border-gray-200 rounded-xl text-black" required minLength={10} />
                  </div>
                   <div>
              ...
              {activeTab === 'images' && (
                <div className="space-y-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Upload your best bridal makeup work to showcase your skills and attract clients.
                  </p>
                  <ImageUpload
              ...
              {activeTab === 'services' && (
                <div className="space-y-6">
                  ...
                  {/* Makeup Types */}
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">What makeup services do you offer? *</h3>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {makeupTypeOptions.map((type) => (
                        <button
                          key={type}
                          type="button"
                          onClick={() => handleMakeupTypeToggle(type)}
                          className={`p-3 rounded-lg border-2 text-left transition-all ${
                            formData.makeupTypes.includes(type)
                    ...
                    <div className="border border-gray-200 rounded-lg p-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input
                            ...
                            placeholder="e.g., Complete Bridal Package"
                            className="w-full"
                          />
                        </div>
                        <div>
                      ...
                      <div className="mt-4">
                        ...
                        <textarea
                          ...
                          placeholder="e.g., Professional makeup application, hair styling, trial session..."
                          rows={3}
