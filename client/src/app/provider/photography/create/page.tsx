          ...
          <div className="mb-8">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h1 className="text-4xl font-bold text-gray-900">Create Photography Service</h1>
                  <p className="text-gray-600 text-lg">Set up your photography service profile</p>
                </div>
              </div>
            </div>
          </div>
