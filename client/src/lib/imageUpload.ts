...
// Upload types
type UploadType = 'venue' | 'profile' | 'document' | 'catering' | 'photography' | 'videography' | 'bridal-makeup' | 'decoration' | 'entertainment' | 'blog';
  ...
  async getUploadConfig(): Promise<UploadConfig> {
    ...
    try {
      ...
      return {
        ...
        uploadTypes: ['venue', 'profile', 'document', 'catering', 'photography', 'videography', 'bridal-makeup', 'decoration', 'blog']
      };
    }
  }
